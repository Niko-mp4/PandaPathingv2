...
@Config
@TeleOp(name = "sample!", group = "tellelelellel")
public class sampleTele extends OpMode {
    ...
    double slideTarget = slideMin, extendPosR = railRMin, extendPosL = railLMin, v4bPos = v4bMUp,
            depositTime, depositStartTime, grabStartTime, grabTime, specRetractStartTime, specRetractTime, specScoreRetryStartTime, specScoreRetryTime,

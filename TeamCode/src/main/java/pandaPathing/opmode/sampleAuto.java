...
public class sampleAuto extends OpMode {
    ...
    private final Pose firstSamplePose = new Pose(14, 10, Math.toRadians(0));

    private final Pose firstScorePose = new Pose(10, 14, Math.toRadians(-45));

    private final Pose secondSamplePose = new Pose(14, 17, Math.toRadians(0));

    private final Pose secondScorePose = new Pose(10, 16, Math.toRadians(-45));

    private final Pose thirdSamplePose = new Pose(15, 19, Math.toRadians(20));
